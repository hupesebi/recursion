...
function everyOther(str, idx=0, string="") {
  if (idx >= str.length) return string;
  string += str[idx];
  return everyOther(str, idx+2, string)
}
...
function revString(str, idx=str.length-1, word="") {
  console.log(idx)
  if (idx<0) return word
  word += str[idx];
  return revString(str, idx-1, word)
}
